...
public class Bode750Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bode750);

        bd1 = findViewById(R.id.bd1750);
        bd2 = findViewById(R.id.bd2750);
        bd3 = findViewById(R.id.bd3750);
        bd4 = findViewById(R.id.bd4750);
        bd5 = findViewById(R.id.bd5750);
    ...
    private void startQuestion(int id) {
        ...
        Intent intent = new Intent(Bode750Activity.this, TestActivity.class);
